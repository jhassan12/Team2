...
public class PacMan {
  ...
  public boolean is_ghost_in_range() {
    ...
    if (myMap.getLoc(loc1).contains(Map.Type.GHOST) 
        ...
        || myMap.getLoc(loc5).contains(Map.Type.GHOST)
        || myMap.getLoc(loc6).contains(Map.Type.GHOST)
        || myMap.getLoc(loc7).contains(Map.Type.GHOST)
        || myMap.getLoc(loc8).contains(Map.Type.GHOST)) {
